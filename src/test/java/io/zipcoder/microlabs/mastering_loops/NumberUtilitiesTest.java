...
public class NumberUtilitiesTest {
    ...
    public void testGetRange1A() {
        ...
        int stop = 10;// Kris changed from 11 to 10
    ...
    public void testGetEvenNumbers() {
        // : Given
        String expected = "681012141618"; // kris changed to even numbers
        int start = 5;
        int stop = 20;
    ...
    public void testGetOddNumbers() {
        // : Given
        String expected = "5791113151719"; // kris changed to odd numbers
        int start = 5;
        int stop = 20;
        int step = 5;
